...
test("search tree nodes are pre-loaded and skip directory refetches", () => {
  assert.match(source, /refreshToken\?: string/);
  assert.match(source, /if \(refreshToken !== undefined && open && loaded\)/);
