...
// Local fork: upstream styles the terminal via app/globals.css; here the
// terminal rules live in their own sheet (globals.css carries uncommitted
// user changes and must not be touched).
...
import type { TerminalTab } from "@/lib/terminal-tab-state";
