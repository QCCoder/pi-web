...
test("module tab ids: constants + isModuleTabId", async () => {
  ...
  assert.deepEqual([...MODULE_TAB_IDS], [FILES_TAB_ID, LOOPS_TAB_ID, "__knowledge__", "__work-items__"]);
  ...
  assert.equal(isModuleTabId("__knowledge__"), true);
  assert.equal(isModuleTabId("__work-items__"), true);
