...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "subagent.stepsBeforeFailure": "失败前已执行 {turns} 轮 / {steps} 步",
    "subagent.writeSummary": "改动 {files} 个文件",
    "subagent.writeSummaryCommits": "改动 {files} 个文件 · {commits} 次提交",
    "subagent.showEarlier": "展开前 {count} 步",
    "subagent.showLess": "收起",
