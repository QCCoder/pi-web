...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.changedFiles": "本会话改动 {count} 个文件",
    "chat.changedFilesTimes": "本会话共改动 {count} 次",
    "chat.subagents": "本会话子代理 {count} 个",
    "chat.subagentStatusPending": "等待中",
    "chat.subagentStatusRunning": "运行中",
    "chat.subagentStatusSucceeded": "已完成",
    "chat.subagentStatusFailed": "已失败",
    "chat.subagentStatusRejected": "已拒绝",
    "chat.subagentStatusSkipped": "已跳过",
    ...
    "chat.loadEarlierCount": "向上滚动加载更早的消息",
