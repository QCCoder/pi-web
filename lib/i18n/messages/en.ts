...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "subagent.stepsBeforeFailure": "Ran {turns} turn(s) / {steps} step(s) before failing",
    "subagent.writeSummary": "Touched {files} file(s)",
    "subagent.writeSummaryCommits": "Touched {files} file(s) · {commits} commit(s)",
    "subagent.showEarlier": "Show {count} earlier step(s)",
    "subagent.showLess": "Show less",
    ...
    "chat.changedFiles": "Changed files ({count})",
    "chat.changedFilesTimes": "Touched {count} times in this session",
    ...
    "chat.loadEarlierCount": "Scroll up to load earlier messages",
