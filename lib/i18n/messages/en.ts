...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.subagents": "Subagents ({count})",
    "chat.subagentStatusPending": "Pending",
    "chat.subagentStatusRunning": "Running",
    "chat.subagentStatusSucceeded": "Succeeded",
    "chat.subagentStatusFailed": "Failed",
    "chat.subagentStatusRejected": "Rejected",
    "chat.subagentStatusSkipped": "Skipped",
